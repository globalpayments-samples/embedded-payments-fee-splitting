# Node.js Embedded Payments Fee Splitting Example

This example demonstrates embedded payments processing with automatic fee splitting using Node.js and the Global Payments SDK.
...
- `server.js` - Embedded payments processor with fee splitting
- `index.html` - Frontend payment form
- `package.json` - Project dependencies and scripts
- `.env.sample` - Template for environment variables
- `lib/` - Embedded Payments classes (SellerManager, SplitCalculator)
...
- Frontend sends card data directly to the Node.js backend
