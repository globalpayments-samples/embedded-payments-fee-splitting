# Node.js Marketplace Fee Splitting Example

This example demonstrates marketplace payment processing with automatic fee splitting using Node.js and the Global Payments SDK.
...
- `server.js` - Marketplace payment processor with fee splitting
- `index.html` - Frontend payment form
- `package.json` - Project dependencies and scripts
- `.env.sample` - Template for environment variables
- `lib/` - Marketplace classes (SellerManager, SplitCalculator)
